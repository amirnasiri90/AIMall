...
• استودیو تصویر — ویرایش تصویر: انتخاب مدل توسط کاربر، نوار پیشرفت و زمان تقریبی هنگام ویرایش
• نمایش نتیجه ویرایش حتی در صورت خطای موقت سرور؛ گالری در تب ویرایش تصویر
• رفع خطای ۴۱۳ (Payload Too Large) برای آپلود تصاویر بزرگ در ویرایش
• بهبود مدیریت خطا و نمایش تصویر ویرایش‌شده در کارت نتیجه`;
